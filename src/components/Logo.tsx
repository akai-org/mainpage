      ...
      >
        <g>
          ...
          <path
            ...
            clipRule="evenodd"
            fill="#FAA21B"
            d="M117.863,117.782v-17.263c-9.81,0-17.839,7.62-18.496,17.263 l-0.044,1.276v17.263c9.81,0,17.839-7.62,18.495-17.263L117.863,117.782z"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            className="dark:fill-foreground"
            fill="#001936"
            d="M170.043,120.958h18.579l-0.031,36.897 c-0.656,9.644-8.686,17.263-18.496,17.263v-17.263L170.043,120.958z"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            className="dark:fill-foreground"
            fill="#001936"
            d="M99.522,142.71c8.802-0.187,15.365-4.473,18.577-9.317 l-0.031,61.122c-0.656,9.644-8.686,17.263-18.496,17.263v-17.263L99.522,142.71z"
          />
        </g>
      </svg>
    </div>
