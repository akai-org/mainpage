    ...
    <>
      <div className="flex-center-col w-full gap-5 px-5 py-20 lg:p-20">
        ...
        <Text className="md:w-1/2">
          Interesujesz się back-endem, front-endem, masz wyczucie designu czy
          może chcesz sprawdzić swoje zdolności do zarządzania i organizacji?
          Dołącz do nas, w każdej z tych ról będziesz mógł się realizować w
          AKAI.
        </Text>
